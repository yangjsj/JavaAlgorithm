...
import regression.xgboost.entity.SplitInfo;
import regression.xgboost.impurity.FindBestSplitGreedyCall;
import regression.xgboost.utils.DeamonThreadFactory;
import regression.xgboost.utils.DummyExecutorService;
...
public class XGBoostTrain {
	...
	public XGBoostTrain(Corpus corpus) {
		this.corpus = corpus;
